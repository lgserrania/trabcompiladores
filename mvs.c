...
enum codinst {
    CRVG, CRCT, SOMA, SUBT, MULT, DIVI, CMIG,
    ...
    while (1) {
        switch (P[i].i) {
            ...
            case CRVG: s++;
                ...
                i++;
                break;
            case ARZG: M[P[i].o] = M[s];
                s--;
                i++;
                break;
            case SOMA: M[s - 1] = M[s - 1] + M[s];
                s--;
                i++;
                break;
            case SUBT: M[s - 1] = M[s - 1] - M[s];
                s--;
                i++;
                break;
            case MULT: M[s - 1] = M[s - 1] * M[s];
                s--;
                i++;
                break;
            case DIVI: M[s - 1] = M[s - 1] / M[s];
                s--;
                i++;
                break;
